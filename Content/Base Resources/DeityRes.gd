...
@export var areas_of_concern: Array[String] = []
@export var edicts: Array[String] = []
@export var anathema: Array[String] = []
...
# Initialization
func _init(name : String = "", desc : String = "", _areas_of_concern : Array[String] = [], _edicts : Array[String] = [], 
			_anathema : Array[String] = [], _symbol : String = "", _divine_attribute : String = "", 
			_divine_font : String = "", _divine_consecration : TraitResource = null, _divine_skill : SkillResource = null, 
			_domains : Array[String] = [], _favored_weapon_group : String = "") -> void:
	d_name = name
	description = desc
