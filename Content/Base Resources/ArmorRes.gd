...
@export var armor_penalty: int = 0
@export var max_dex: int = 0
@export var check_penalty: Dictionary = {}
...
func _init(name : String = "", desc : String = "", _traits : Array[TraitResource] = [], 
			...
			_armor_group : String = "", _armor_penalty : int = 0, _max_dex : int = 0, _check_penalty : Dictionary = {}, 
			_spell_failure : int = 0, _speed : int = 0) -> void:
